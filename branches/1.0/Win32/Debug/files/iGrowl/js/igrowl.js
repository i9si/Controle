...
;( function($) {
	...
	var animStart = 'webkitAnimationStart oanimationstart MSAnimationStart animationstart',
		...
		growlTemplate = '<div class="igrowl animated" role="alert"><div class="igrowl-text"></div><button class="igrowl-dismiss"><i class="fa fa-times" aria-hidden="true"></i></button></div>';
	...
	setContent = function(options){
		...
		if ( options.image.src ) {
			...
			template.prepend('<div class="igrowl-icon fa '+ options.icon + '"></div>');
		}
