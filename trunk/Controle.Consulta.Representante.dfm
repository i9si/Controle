inherited ControleConsultaRepresentante: TControleConsultaRepresentante
  ...
  inherited QryConsulta: TADOQuery
    ...
    SQL.Strings = (
      ...
      '                       '#39'1'#39', '#39'1 '#8211' SIMPLES NACIONAL'#39','
        ...
        'ributario'
      '         FROM representante res'
      '        INNER JOIN pessoa pes'
      '           ON pes.id = res.id'
      '       INNER JOIN filial fil'
      '           ON fil.id =  :filial_id'
      '       WHERE nvl(res.ativo,'#39' '#39') = '#39'S'#39
      ...
      '            AND nvl(pes.cpf_cnpj,'#39' '#39') like :cpf_cnpj'
        ...
        '            AND nvl(fil.codigo_regime_tributario,'#39#39') like :codig' +
        'o_regime_tributario'
      '          ORDER BY pes.id'
      '       ) sub')
  end
