inherited ControleConsultaBaixarMultiplosReceber: TControleConsultaBaixarMultiplosReceber
  ClientHeight = 582
  ClientWidth = 971
  Caption = 'ControleConsultaBaixarMultiplosReceber'
  BorderStyle = bsNone
  PixelsPerInch = 96
  TextHeight = 13
  inherited UniPanel1: TUniPanel
    ...
    inherited UniPanelCaption: TUniPanel
      ...
      inherited UniLabelCaption: TUniLabel
        Width = 185
        Caption = 'Baixa multiplos contas a receber'
        ExplicitWidth = 185
      end
