inherited ControleCadastroTituloPagar: TControleCadastroTituloPagar
  ...
  object DspTituloCategoria: TDataSetProvider [16]
    DataSet = QryTituloCategoria
    Left = 652
    Top = 100
  end
  object CdsTituloCategoria: TClientDataSet [17]
    Aggregates = <>
    FieldDefs = <
      item
        Name = 'ID'
  ...
  object DscTituloCategoria: TDataSource [18]
    DataSet = CdsTituloCategoria
    OnStateChange = DscCadastroStateChange
    Left = 526
    Top = 98
  end
  object QryTituloCategoria: TADOQuery [19]
    Connection = ControleMainModule.ADOConnection
    CursorType = ctStatic
    LockType = ltReadOnly
    EnableBCD = False
  ...
  object QryTituloPagamentos: TADOQuery [21]
    Connection = ControleMainModule.ADOConnection
    CursorType = ctStatic
    LockType = ltReadOnly
    EnableBCD = False
  ...
  object CdsTituloPagamentos: TClientDataSet [22]
    Aggregates = <>
    FieldDefs = <
      item
        Name = 'ID'
  ...
  object DscTituloPagamentos: TDataSource [23]
    DataSet = CdsTituloPagamentos
    OnStateChange = DscCadastroStateChange
    Left = 30
    Top = 219
  end
  object DspTituloPagamentos: TDataSetProvider [24]
