inherited ControleCadastroTituloReceber: TControleCadastroTituloReceber
    ...
    object UniPageControl1: TUniPageControl
      ...
      object UniTabSheet3: TUniTabSheet
        ...
        object UniPanelClient: TUniPanel
          ...
          object UniDBLookupComboBoxCondicaoPagamento: TUniDBLookupComboBox
            Tag = 5
            Left = 512
            Top = 49
            Width = 185
  ...
  object CdsCondicoesPagamento: TClientDataSet [13]
    Aggregates = <>
    FieldDefs = <
      item
        Name = 'ID'
  ...
  object DspTituloPagamentos: TDataSetProvider [16]
    DataSet = QryTituloPagamentos
    Left = 158
    Top = 261
  end
  object DscTituloPagamentos: TDataSource [17]
    DataSet = CdsTituloPagamentos
    OnStateChange = DscCadastroStateChange
    Left = 166
    Top = 219
  end
  object CdsTituloPagamentos: TClientDataSet [18]
    Aggregates = <>
    FieldDefs = <
      item
        Name = 'ID'
  ...
  object QryTituloPagamentos: TADOQuery [19]
    Connection = ControleMainModule.ADOConnection
    CursorType = ctStatic
    LockType = ltReadOnly
    EnableBCD = False
  ...
  object CdsTituloCategoria: TClientDataSet [21]
    Aggregates = <>
    FieldDefs = <
      item
        Name = 'ID'
  ...
  object DspTituloCategoria: TDataSetProvider [22]
    DataSet = QryTituloCategoria
    Left = 270
    Top = 160
  end
  object DscTituloCategoria: TDataSource [23]
